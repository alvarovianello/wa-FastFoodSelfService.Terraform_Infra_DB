resource "aws_db_instance" "postgres_db" {
  ...
  db_subnet_group_name   = "default"                           # Grupo de sub-redes (padrão)
  vpc_security_group_ids = [aws_security_group.sg-fastfood.id] # ID do grupo de segurança (alterar para o existente)
